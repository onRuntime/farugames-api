...
public enum LangOld {
	...
	private LangOld(String english, String french, String german, String spanish) {
	...
	public static LangOld getByString(String language) {
		return LangOld.valueOf(language) != null ? LangOld.valueOf(language) : LangOld.ENGLISH;
	}
	
	public String in(LangOld language) {
